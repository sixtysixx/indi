      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">Cc Genrate</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Cc Gen</li>
              </ol>
            </nav>
          </div>
          <div class="row">
...
<span style="color:#fff; font-size: 18px; font-weight: bold;">Indian Binner CC Gen</span>
<hr>
</nav>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <button type="submit" class="btn btn-info btn-block" onclick="copy()">Copy Cards</button>
                </div>
            </div>
